...
const DataManager = {
    ...
    getResponseTimeDistribution() {
        ...
        // ⚡ BOLT OPTIMIZATION:
        // Single pass to find max time without allocating an intermediate map array
        // and without using Math.max(...times) which can cause stack overflow on large datasets.
        ...
        // ⚡ BOLT OPTIMIZATION:
        // Use an integer-indexed array for fast bucketing instead of string interpolation
        // and object property lookups inside the loop.
