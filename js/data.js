...
const DataManager = {
    ...
    getResponseTimeDistribution() {
        ...
        // Single pass to find max to avoid spread operator maximum call stack exceeded errors
        let maxTimeRaw = 0;
        ...
        // Use integer-indexed array for fast binning instead of object properties
        ...
        // Map to string labels after loop to avoid string interpolation cost in loop
