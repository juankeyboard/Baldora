...
const DataManager = {
    ...
    getSessionStats() {
        ...
        // ⚡ Bolt Optimization: Single-pass loop to prevent array method chaining (.filter/.map/.reduce) overhead
    ...
    getResponseTimeDistribution() {
        ...
        // ⚡ Bolt Optimization: Single-pass loop to find maxTime
        // Prevents "Maximum call stack size exceeded" error from Math.max(...times) with > 100k items
        let maxTime = 0;
        ...
        // ⚡ Bolt Optimization: Single-pass loop without creating intermediate arrays
        for (let i = 0; i < this.history.length; i++) {
    ...
    getAccuracyDistribution() {
        ...
        // ⚡ Bolt Optimization: Single-pass loop instead of two .filter().length passes
        for (let i = 0; i < this.history.length; i++) {
