...
const DataManager = {
    ...
    getSessionStats() {
        ...
        // Optimization: Single pass instead of filter().map().reduce()
    ...
    getErrorsByTable() {
        ...
        // Contar errores
        // Optimization: Single pass instead of filter().forEach()
    ...
    getResponseTimeDistribution() {
        ...
        // Optimization: Find max time in a single pass without using spread operator to avoid call stack limits
        let actualMaxTime = 0;
        for (let i = 0; i < this.history.length; i++) {
        ...
        // Populate bins in a single loop
        for (let i = 0; i < this.history.length; i++) {
    ...
    getAccuracyDistribution() {
        ...
        // Optimization: Single pass instead of multiple filter().length
        for (let i = 0; i < this.history.length; i++) {
