...
const DataManager = {
    ...
    getSessionStats() {
        ...
        // ⚡ Bolt: Single-pass loop to avoid filter/map/reduce overhead
    ...
    getErrorsByTable() {
        ...
        // ⚡ Bolt: Single-pass loop sin filter/forEach
    ...
    getResponseTimeDistribution() {
        ...
        let maxTimeFound = 0;
        // ⚡ Bolt: Single-pass loop en vez de Math.max(...times) para evitar stack overflow
        for (let i = 0; i < len; i++) {
        ...
        // ⚡ Bolt: Array lookup en vez de crear llaves de string por item
        for (let i = 0; i < len; i++) {
        ...
        return { labels, counts: binCounts };
    },
    ...
    getAccuracyDistribution() {
        ...
        // ⚡ Bolt: Single-pass loop para evitar filter
        for (let i = 0; i < len; i++) {
