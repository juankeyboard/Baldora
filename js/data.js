...
const DataManager = {
    ...
    getResponseTimeDistribution() {
        // ⚡ Bolt Optimization: Avoid spread operator `Math.max(...times)` which crashes with "Maximum call stack size exceeded" on large datasets.
        // Use a single-pass loop with an integer-indexed array for binning to avoid slow string interpolations and object lookups.
        ...
        const maxTime = Math.min(maxObservedTime, 10000); // Cap at 10s
