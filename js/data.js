...
const DataManager = {
    ...
    getResponseTimeDistribution() {
        ...
        // Find max response time without Math.max(...times) which overflows call stack for large arrays
        // and avoid allocating an intermediate `times` array via .map()
        ...
        // Single-pass binning avoiding string interpolation and object dictionary lookups
        for (let i = 0; i < historyLen; i++) {
        ...
        // Map buckets to formatted string labels at the very end
