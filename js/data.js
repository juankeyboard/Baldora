...
const DataManager = {
    ...
    getResponseTimeDistribution() {
        ...
        // ⚡ Bolt: Single-pass para encontrar el máximo y evitar 'Maximum call stack size exceeded'
        // con Math.max(...times) en historiales grandes (>100,000 elementos)
        ...
        // ⚡ Bolt: Usar array indexado por enteros para el binning para evitar
        // overhead de interpolación de strings y lookups de propiedades en el loop
        const bins = new Array(numBins).fill(0);

        for (let i = 0; i < this.history.length; i++) {
            const t = this.history[i].response_time;
            const cappedTime = t < maxTime ? t : maxTime; // Math.min es más lento
        ...
        // Crear labels de string solo una vez al final
